  ...
  return (
    <div>
      <Container fluid style={{ color: 'black' }}>
        <Row style={{ 'height': '60vh', 'alignItems': 'end', backgroundImage:`url(${dg})`,backgroundSize:'cover',opacity:'60%',backgroundAttachment:'fixed' }}>
          <Col className='m-4' style={{ 'alignContent': 'center' }}>
            <h1 className='mb-4' style={{ 'textAlign': 'center' }}>DIGITAL PROGRAMMING</h1>
          </Col>
        </Row>
        <Row style={{ 'height': '80vh', 'alignItems': 'center', backgroundColor: 'lavender', backgroundImage:`url(${vc})`,backgroundSize:'cover',backgroundAttachment:'fixed'}}>
          <Col xs={5} >
            <div  className='m-4 text-cyan' style={{ 'alignContent': 'center', justifyContent: 'center',color:'black' }}>
