...
const DigProg = () => {
  return (
    <div>
      <Container fluid style={{ color: 'black',fontSize:'1.2rem' }}>
        <Row style={{ 'height': '60vh', 'alignItems': 'end', backgroundImage:`url(${dg})`,backgroundSize:'cover',opacity:'60%',backgroundAttachment:'fixed', fontSize:'1.2rem' }}>
          <Col className='m-4' style={{ 'alignContent': 'center' }}>
            <h1 className='mb-4' style={{ 'textAlign': 'center' }}>DIGITAL PROGRAMMING</h1>
          </Col>
        </Row>
        <Row style={{ 'height': 'fit-content', 'alignItems': 'center', 'minHeight':'80vh',backgroundColor: 'lavender', backgroundImage:`url(${vc})`,backgroundSize:'cover',backgroundAttachment:'fixed'}}>
          <Col lg={5} xs={11}>
            <Container  className='m-4 text-cyan' style={{ 'alignContent': 'center', justifyContent: 'center',color:'white' }}>
