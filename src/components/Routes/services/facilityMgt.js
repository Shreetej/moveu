  ...
  return (
    <div>
      <Container fluid style={{ color: 'white' }}>
        <Row style={{ 'height': '85vh', 'alignItems': 'center', backgroundColor: 'azure', backgroundImage: `url(${Gym})`, backgroundSize: 'cover', fontSize: '1.2 rem' }}>
          <Col className='m-4' xs={11} style={{ 'textAlign': 'center', 'alignContent': 'bottom', color: '#FDFDFD', fontWeight: 'bold' }}>
            ...
            <p className='mt-5' style={{ 'textAlign': 'center' }}></p>
          </Col>
        </Row>
        <Row style={{ 'height': 'fit-content', 'alignItems': 'center', backgroundColor: 'lavender', backgroundImage: `url(${Design1})`, backgroundSize: 'cover', fontSize: '1.2em' }}>
          <Col lg={6}></Col>
        ...
        <Row style={{ 'height': 'fit-content', 'alignItems': 'center', backgroundColor: 'honeydew', backgroundImage: `url(${Equipment})`, backgroundSize: 'cover', opacity: '85%', fontSize: '1.2rem' }}>
          <Col className='m-4' xs={11} lg={5}>
        ...
        <Row style={{ 'height': 'fit-content', 'alignItems': 'center', backgroundColor: 'azure', backgroundImage: `url(${MissionImage})`, backgroundSize: 'cover', fontSize: '1.2rem' }}>
          <Col lg='6'></Col>
